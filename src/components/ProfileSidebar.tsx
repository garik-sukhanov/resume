...
import { Download, Mail, Github, MapPin, Phone, Linkedin } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-xl border border-[#d0d7de] dark:border-[#30363d] overflow-hidden bg-white dark:bg-[#0d1117] shadow-sm ring-1 ring-[#d0d7de] dark:ring-transparent">
        ...
        <div className="p-6 space-y-4">
          <div className="space-y-1">
            <h2 className="text-2xl font-bold text-[#1f2328] dark:text-[#f0f6fc]">Alexander Sukhanov</h2>
            <p className="text-[#636c76] dark:text-[#8b949e] font-medium">Senior Fullstack Developer</p>
          </div>
          ...
          <div className="space-y-3 text-sm text-[#24292f] dark:text-[#c9d1d9]">
            ...
            <div className="flex items-center gap-3">
              ...
              <a href={`mailto:${t('contact.email')}`} className="hover:text-[#0969da] dark:hover:text-[#2f81f7] hover:underline transition-all">
                {t('contact.email')}
              </a>
            </div>
            <div className="flex items-center gap-3">
              <Phone className="w-4 h-4 text-[#636c76] dark:text-[#8b949e]" />
              <a href={`tel:${t('contact.phone')}`} className="hover:text-[#0969da] dark:hover:text-[#2f81f7] hover:underline transition-all">
                {t('contact.phone')}
              </a>
            </div>
            <div className="flex items-center gap-3">
              <Github className="w-4 h-4 text-[#636c76] dark:text-[#8b949e]" />
              <a href={`https://${t('contact.github')}`} target="_blank" rel="noopener noreferrer" className="hover:text-[#0969da] dark:hover:text-[#2f81f7] hover:underline transition-all">
                GitHub
              </a>
            </div>
            <div className="flex items-center gap-3">
              <Linkedin className="w-4 h-4 text-[#636c76] dark:text-[#8b949e]" />
              <a href={`https://${t('contact.linkedin')}`} target="_blank" rel="noopener noreferrer" className="hover:text-[#0969da] dark:hover:text-[#2f81f7] hover:underline transition-all">
                LinkedIn
              </a>
            </div>
          </div>
      ...
      <div className="p-6 rounded-xl border border-[#d0d7de] dark:border-[#30363d] bg-white dark:bg-[#0d1117] shadow-sm ring-1 ring-[#d0d7de] dark:ring-transparent">
        <h3 className="text-sm font-bold text-[#1f2328] dark:text-[#f0f6fc] mb-3 uppercase tracking-wider">{t('coverLetter.title')}</h3>
